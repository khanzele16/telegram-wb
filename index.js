...
new bullmq_1.Worker("kickUsers", (job) => __awaiter(void 0, void 0, void 0, function* () {
    const { chatId, userId, username } = job.data;
    try {
        yield bot.api.banChatMember(chatId, userId);
        yield bot.api.unbanChatMember(chatId, userId);
...
// создаём очередь
const kickQueue = new bullmq_1.Queue("kickUsers", { connection });
// --- тестовая задача ---
(() => __awaiter(void 0, void 0, void 0, function* () {
    yield kickQueue.add("kick", {
